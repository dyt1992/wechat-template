...
export type VantDatetimePickerProps = {
  ...
  filter?: (type: string, values: string[] | number[]) => string[] | number[] // 选项过滤函数
...
declare const VantDatetimePicker: ComponentType<VantDatetimePickerProps>
